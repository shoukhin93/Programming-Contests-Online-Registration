            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="jumbotron">
                        ...
                        <p>Already have an account? try <a href="#" data-toggle="modal" data-target="#signinModal">Sign
                                in</a></p>
                    </div>
                </div>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <select id="year" name="studentYear" class="form-control">
                                <option style="color: black" value="" disabled selected hidden>Select Year</option>
